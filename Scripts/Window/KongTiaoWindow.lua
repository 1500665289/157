...
-- 声明局部回调函数
local function OnClick11(context)
    local self = context.sender.data;
    self.WenDu = self.WenDu - 100;
    self:reWenDu();
end

local function OnClick12(context)
    local self = context.sender.data;
    self.WenDu = self.WenDu - 10;
    self:reWenDu();
end

local function OnClick13(context)
    local self = context.sender.data;
    self.WenDu = self.WenDu - 1;
    self:reWenDu();
end

local function OnClick14(context)
    local self = context.sender.data;
    self.WenDu = self.WenDu + 1;
    self:reWenDu();
end

local function OnClick15(context)
    local self = context.sender.data;
    self.WenDu = self.WenDu + 10;
    self:reWenDu();
end

local function OnClick16(context)
    local self = context.sender.data;
    self.WenDu = self.WenDu + 100;
    self:reWenDu();
end
