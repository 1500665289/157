...
function tbMagic:TargetCheck(key, t) 
    ...
    if t.ThingType == CS.XiaWorld.g_emThingType.Npc and 
       t.Race.RaceType ~= CS.XiaWorld.g_emNpcRaceType.Animal and 
       t.IsLingering == true then
        return true
    else
        return false
    end
